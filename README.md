...
กฎเดียวที่ต้องจำ: **ม่วงคราม = สิ่งที่กดได้ · สี = สถานะข้อมูล · เทา = โครงสร้างอาคาร**
...
| 2 | เทาเข้ม | กำลังเดินตามปกติ | รอชำระ กำลังซ่อม มีผู้เช่า |
| 3 | เขียว | จบแล้วด้วยดี | ชำระแล้ว ปิดงาน |
| 4 | เหลือง | ต้องตามอีกหน่อย | จองแล้ว ชำระบางส่วน ใกล้หมดอายุ |
| 5 | แดง | ต้องทำเดี๋ยวนี้ | เกินกำหนด งานด่วน |

สีไม่เคยเป็นตัวบอกความหมายเพียงอย่างเดียว ทุกที่ที่ใช้สีต้องมีตัวหนังสือ ไอคอน หรือลวดลายกำกับ
ในผังชั้น พื้นที่ส่วนกลาง (ทางเดิน บันได ลิฟต์ ทางเข้า-ออก ห้องน้ำ) เป็นเทาเหมือนกันหมดและแยกด้วยไอคอน
เพื่อให้สีทั้งหมดเหลือไว้บอกสถานะห้องอย่างเดียว — ค่าสีจริงอยู่ใน `src/app/globals.css`
